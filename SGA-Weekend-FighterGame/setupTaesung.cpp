...
void playGround::setupTaesung()
{
	...
	IMAGEMANAGER->addFrameImage("테스트_이동", "resource/yuhoon/testCharacter/move.bmp", 621, 172, 9, 2, true);

	IMAGEMANAGER->addFrameImage("테스트_달리기", "resource/yuhoon/testCharacter/run.bmp", 624, 126, 8, 2, true);
	
	IMAGEMANAGER->addFrameImage("테스트_발차기", "resource/yuhoon/testCharacter/kick.bmp", 377, 164, 5, 2, true);
	
	IMAGEMANAGER->addFrameImage("테스트_점프", "resource/yuhoon/testCharacter/jump.bmp", 207, 83,3, 2, true);
	
	IMAGEMANAGER->addFrameImage("테스트_점프공격", "resource/yuhoon/testCharacter/jump_attack.bmp", 406, 162, 5, 2, true);
	
	IMAGEMANAGER->addFrameImage("테스트_공격", "resource/yuhoon/testCharacter/attack.bmp", 435, 156, 5, 2, true);
