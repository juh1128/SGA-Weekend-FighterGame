...
void playGround::setupGuenhwa()
{
	...
	IMAGEMANAGER->addFrameImage("terryMoveJump", "resource/geunhwa/terryMoceJump.bmp", 1430, 1142, 5, 2, true, RGB(255, 0, 255));
	...
	KEYANIMANAGER->addCoordinateFrameAnimation("terryLeftDashMove", "terryDashMove", 10, 19, 8, false, false);
