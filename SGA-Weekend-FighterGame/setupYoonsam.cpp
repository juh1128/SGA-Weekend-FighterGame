...
void playGround::setupYoonsam()
{
	IMAGEMANAGER->addFrameImage("Mauru_idle", "resource/yoonsam/Mauru/Mauru_idle_.bmp", 500, 780, 5, 6, true);
	...
	KEYANIMANAGER->addCoordinateFrameAnimation("Mauru_sit_Right", "Mauru_sit", 0, 9, 7, false, true);
	KEYANIMANAGER->setCollisionRect("Mauru_sit_Right", RectMakeCenter(10, 10, 80, 110));

	KEYANIMANAGER->addCoordinateFrameAnimation("Mauru_sit_Left", "Mauru_sit", 10, 19, 7, false, true);
	KEYANIMANAGER->setCollisionRect("Mauru_sit_Left", RectMakeCenter(10, 10, 80, 110));

	KEYANIMANAGER->addCoordinateFrameAnimation("Mauru_idle_Right", "Mauru_idle", 0, 13, 5.5f, false, true);
	KEYANIMANAGER->setCollisionRect("Mauru_idle_Right", RectMake(10,10, 80, 110));

	KEYANIMANAGER->addCoordinateFrameAnimation("Mauru_idle_Left", "Mauru_idle", 15, 29, 5.5f, false, true);
	KEYANIMANAGER->setCollisionRect("Mauru_idle_Left", RectMake(10, 10, 80, 110));

	KEYANIMANAGER->addCoordinateFrameAnimation("Mauru_move_Right", "Mauru_move", 0, 11, 7, false, false);
	KEYANIMANAGER->setCollisionRect("Mauru_move_Right", RectMakeCenter(10, 10, 80, 110));
	
	int Mauru[] = { 19,18,17,16,15,24,23,22,21,20,29,28 };
	KEYANIMANAGER->addArrayFrameAnimation("Mauru_move_Left", "Mauru_move", Mauru, 2, 10, false);
